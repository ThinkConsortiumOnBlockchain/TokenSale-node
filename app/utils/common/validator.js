    ...
    publicRouteValidate:function (method) {
        return function (req, res, next) {
            switch(method) {
                ...
                case 'signup' :
                    req.checkBody('firstName', helpers.checkIfRequired('firstName')).notEmpty()
                        .len(2, 50).withMessage(helpers.checkLength('firstName', 2, 50));

                    req.checkBody('lastName', helpers.checkIfRequired('lastName')).notEmpty()
                        .len(2, 50).withMessage(helpers.checkLength('lastName', 2, 50));
                ...
                case 'resetPassword' :
                    ...
                    req.checkBody('newPassword', helpers.checkIfRequired('newPassword')).notEmpty();
        ...
        return function (req, res, next) {
            switch(method) {
                ...
                case 'store' :
                    ...
                    req.checkBody('transactionHash', helpers.checkIfRequired('transactionHash')).notEmpty();
                    req.checkBody('status', helpers.checkIfRequired('status')).notEmpty();
