...
module.exports = {
    ...
    SECURE_VERIFICATION     : 'Secure login has enabled for this account. Please enter OTP to login.',
    ...
    REGISTRATION_SUCCESS    : 'We have sent an OTP on your email. Please verify your email address.',
